...
var DEFAULT_REFERENCE_PATH =
    "/Users/songyuhan/Library/Mobile Documents/iCloud~md~obsidian/Documents/Claude Code/Projects/ps\u6279\u91CF\u5904\u7406/reserach/psd/H26_SET_01_SASS_&_SUNSHINE_INTL_INTO_RGB_after.psd";
...
function runBatch(cfg, onProgress, onLog) {
    ...
    // Log file was written incrementally via pushLog; nothing extra needed here.
    return { ok: ok, fail: fail, elapsed: elapsed, outFolder: outFolder.fsName, logFile: logFile.fsName };
}
